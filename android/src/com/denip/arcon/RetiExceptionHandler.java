...
public class RetiExceptionHandler implements Thread.UncaughtExceptionHandler {

    private Thread.UncaughtExceptionHandler defaultUEH;
    private String localPath;
    public RetiExceptionHandler(String localPath) {
    ...
    private void writeToFile(String currentStacktrace) {
        try {
          ...
          //  SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd_HH:mm:ss");
            ...
            fileWriter.flush();
            fileWriter.close();
            FileUploadTask t = new FileUploadTask(dir.toString()+"/",filename);
            t.execute();
        } catch (Exception e) {
